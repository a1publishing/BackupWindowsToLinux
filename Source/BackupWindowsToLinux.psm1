...
$PublicAlias = $PublicScriptBlock.Ast.FindAll({ $args[0] -is [System.Management.Automation.Language.AttributeAst] }, $true).Where{ $_.TypeName.FullName -eq 'alias' }.PositionalArguments.Value
